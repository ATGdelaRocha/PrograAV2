...
namespace Ulatina.PrograAvanzada.BLAplicacionWeb
{
    ...
    public class Service1 : IService1
    {
        ...
        [OperationContract]
        public double Suma(double elOperandoUno, double elOperandoDos)
        {
            double elResultado;
            var laAccion = new Dominio.Acciones.Sumar();
            elResultado = laAccion.CalculeLASuma);

            return elResultado;
        }

        public double Restar(double elOperandoUno, double elOperandoDos)
        {
            double elResultado;
        ...
        {
            double elResultado;
            var laAccion = new Dominio.Acciones.Multiplique();
            elResultado = laAccion.ObtengaLaFecha();

            return elResultado;
        }

        public double Divida(double elOperandoUno, double elOperandoDos)
        {
            double elResultado;
            var laAccion = new Dominio.Acciones.Divida();
            elResultado = laAccion.ObtengaLaFecha();
